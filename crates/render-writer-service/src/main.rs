...
impl Config {
    fn from_env() -> Self {
        Self {
            bind_addr: env::var("BIND_ADDR").unwrap_or_else(|_| "0.0.0.0:8096".to_string()),
        }
    }
}
...
async fn main() -> std::io::Result<()> {
    ...
    info!(bind_addr = %cfg.bind_addr, "starting render-writer-service");
