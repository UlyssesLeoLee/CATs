...
| 状态 | 评审前草稿 |
| 密级 | 仅社内 |
| 上游文档 | [CATs 微服务架构设计书 v1.0](../../02-基础设计/架构设计/CATs_微服务架构设计书_v1.0.md)、[CATs 技术选型书 v2.0](../../02-基础设计/技术选型/CATs_技术选型书_v2.0.md)、[CATs 接口设计书 v2.0](../接口设计/CATs_接口设计书_v2.0.md)、[CATs 数据库设计书 v2.0](../数据库设计/CATs_数据库设计书_v2.0.md)、[OFCAT 模块设计书 v1.0（历史/旧架构参考，格式沿用）](./OFCAT_模块设计书_v1.0.md) |
...
本书是《CATs 微服务架构设计书 v1.0》§21 承诺的模块详细设计文档，覆盖：①后端各微服务内部代码分层与目录/crate 结构，②Tauri 客户端内部模块，③Next.js Web 控制台目录结构，④媒体处理管线各阶段的输入输出契约与失败重试/幂等设计，⑤跨服务共享的公共基础库/SDK。接口契约见《CATs 接口设计书 v2.0》，数据表结构见《CATs 数据库设计书 v2.0》。
