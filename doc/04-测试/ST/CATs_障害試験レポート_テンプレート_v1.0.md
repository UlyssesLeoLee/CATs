# CATs 障害試験レポート テンプレート v1.0

> **ドキュメント番号**：CATs-CHS-REP-001
> **バージョン**：v1.0
> **作成日**：2026-08-26
> **作者**：架构师 + SRE + QA（worker 代签 per DEC-008）
...
| 役割 | 氏名 | 承認 | 日付 | 備考 |
|------|------|------|------|------|
| 起案 | 架构师 + SRE + QA | ☑ | 2026-08-26 | worker 代签 per DEC-008 |
| レビュー | — | ☐ | — | M2 末評価会前 |
| 承認 | — | ☐ | — | M2 末評価会前 |
...
| 3 | **PG 障害** | プライマリ / レプリカ停止、ディスクフル、WAL 破損 | PostgreSQL 16 + CloudNativePG |
