...
| 下游文档 | [CATs 微服务架构设计书 v1.0](../../02-基础设计/架构设计/CATs_微服务架构设计书_v1.0.md)、[CATs 技术选型书 v2.0](../../02-基础设计/技术选型/CATs_技术选型书_v2.0.md)、[CATs 测试设计书 v1.0](../../04-测试/测试设计书/CATs_测试设计书_v1.0.md) |
...
- **存储可靠性**：PostgreSQL 采用 CloudNativePG 管理 1 主 2 从集群，RPO = 0，RTO <= 30 s。
