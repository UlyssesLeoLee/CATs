...
| 状态 | 评审前草稿 |
| 密级 | 仅社内 |
| 上下游文档 | 上游：[CATs 微服务架构设计书 v1.0](./CATs_微服务架构设计书_v1.0.md)、[CATs 技术选型书 v2.0](../技术选型/CATs_技术选型书_v2.0.md)、[CATs 命名变更说明](./CATs_命名变更说明.md)<br>下游：[CATs 接口设计书 v2.0](../../03-详细设计/接口设计/CATs_接口设计书_v2.0.md)、[CATs 数据库设计书 v2.0](../../03-详细设计/数据库设计/CATs_数据库设计书_v2.0.md)、[CATs 模块设计书 v2.0](../../03-详细设计/模块设计/CATs_模块设计书_v2.0.md) |
