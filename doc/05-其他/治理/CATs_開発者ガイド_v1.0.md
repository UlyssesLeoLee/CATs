...
> **版本**：v1.2（基线升级 WT-H2：Rust 1.98.0 + PG 18.6 + pgvector 0.8.6.6 锁定）  
> **基线**：v1.1（2026-08-26）+ CATs_技术基线_v1.0（2026-08-26 锁定）  
> **创建日**：2026-08-20  
> **更新**：v1.0 → v1.1（2026-08-26 增 §5.5）;v1.1 → v1.2（2026-08-26 WT-H2 基线升级,Rust 锁定 1.98.0 / PG 18.6 + pgvector 0.8.6.6）  
> **作者**：架构师 + Rust Lead + 前端 Lead + DBA（worker 代签 per DEC-008）
...
| **v1.2** | **2026-08-26** | **架构师 + Rust Lead + 前端 Lead + DBA（worker 代签 per DEC-008）** | **基线升级(WT-H2)**:§3.2 必装工具 Rust 行 "最新 stable" → **"1.98.0(锁定,2026-08-20 release,见 CATs_技术基线_v1.0)"**;PostgreSQL 镜像/客户端更新到 18.6 + pgvector 0.8.6.6;加 `CATs_技术基线_v1.0 §1` 引用;见 `CATs_Rust技术选型书_v1.1` §3.1 ADR-R-01** |
...
| Rust | **1.98.0（锁定，2026-08-20 release，见 CATs_技术基线_v1.0）** | `curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs \| sh`（跟随官方，2026-08-20 决议 QA-024） |
| cargo | 随 Rust | 随 Rust |
| Node.js | 20 LTS | nvm |
| pnpm | 9+ | `npm i -g pnpm` |
