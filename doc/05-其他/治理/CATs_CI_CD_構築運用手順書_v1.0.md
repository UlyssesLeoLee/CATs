# CATs CI/CD 構築・運用手順書 v1.1（基线升级）

> **文档编号**：CATs-IMPL-053  
> **フェーズ**：53/57/58 開発環境構築 / ビルド / CI  
> **关联任务**：150 任务 #53、#57、#58、QA-041（性能基线）、QA-042（K3s HA）  
> **版本**：v1.1（基线升级 WT-H2：Rust 1.98.0 + PG 18.6 + pgvector 0.8.6）  
> **创建日**：2026-08-20
> **修订日**：2026-08-26  
...
| **v1.1** | **2026-08-26** | **SRE + 架构师 + Rust Lead + DBA（worker 代签 per DEC-008）** | **基线升级(WT-H2)**:Rust 工具链 "跟随最新 stable" → **锁定 1.98.0**;PostgreSQL 镜像 "PostgreSQL 16" / "pg16" → **"PostgreSQL 18.6" / "pg18"**;pgvector 锁定 0.8.6;引用 `CATs_技术基线_v1.0 §1`** |
...
|------|------|------|
| Git | 2.42+ | 版本控制 |
| Rust | **1.98.0** (2026-08-20 release,2026-08-26 锁定 QA-024) | 后端开发 |
